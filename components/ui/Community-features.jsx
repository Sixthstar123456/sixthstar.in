...
export default function IntegrationsShowcaseCommunity() {
    ...
    <div className="w-full bg-gray-50 py-16 px-6">
      <div className="max-w-screen-1xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-20">
          Key Features of Carbonio Community Edition
        </h1>
...
Switch between multiple profiles, collaborate through shared accounts and folders.
            ...
            >
              ...
              <div>
                <h3 className="font-bold text-xl mb-2">Integrated Video Chat for Team  Communication</h3>
                <p className="text-gray-600">
                 Stay connected with your team using built-in, secure video conferencing—no third-party tools needed. Carbonio Community Edition enables real-time video meetings directly.
